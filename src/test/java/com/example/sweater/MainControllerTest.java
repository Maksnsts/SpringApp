...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//*[@id='navbarSupportedContent']/div").string("user1")); // is the user correct
    ...
    public void messageListTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                .andDo(print())
                .andExpect(authenticated())
                .andExpect(xpath("//div[@id='message-list']/div").nodeCount(4)); //  number of nodes
    }
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main").param("filter", "my-tag"))
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=1]").exists()) // czy istnieje element
